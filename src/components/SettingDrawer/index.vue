...
const { downloadPath, isDanmaku, isDelete, isFolder, isMerge, isSubtitle, downloadingMaxSize, isDownloadAudio } = storeToRefs(store.settingStore())
...
const open = () => {
  ...
  modelRef.isDownloadAudio = isDownloadAudio.value
